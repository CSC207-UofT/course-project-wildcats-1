...
public class BoardManager {
    ...
    public boolean checkValidPawnMove(Board board, Pawn pawn, String loc) {
        ...
        boolean whiteTurn = pawn.getLocation().equals("white");

        // True if only the pawn is black
        boolean blackTurn = pawn.getLocation().equals("black");
     ...
     */
    public boolean checkValidCheckmate(Board board, String color) {
